...
// 			if (lastFish > 0 && fish < 0) {
// 				//last fish is going down
// 				if (Math.abs(lastFish) < Math.abs(fish)) {
// 					// fish is bigger
// 					survivors.pop();
// 					if (i <= 0) {
// 						survivors.push(fish);
...
// 	}
// 	function addFish(i) {
// 		if (B[i] > 0) var fish = A[i];
// 		else var fish = -A[i];
// 		if (survivors.length == 0) survivors.push(fish);
// 		else processFish(fish);
// 	}
// 	var survivors = [];
// 	addFish(0);
